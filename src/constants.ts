...
export const DEFAULT_RECORD_SAMPLE_RATE = "auto";
export const DEFAULT_TRANSCRIBE_SAMPLE_RATE = 16_000;
export const DEFAULT_AUTO_DOWNLOAD_MODEL = true;
export const MODEL_DOWNLOAD_INACTIVITY_TIMEOUT_MS = 120_000;
export const DEFAULT_RECORD_SYNC = true;
export const DEFAULT_STREAM_CAPTURE = -1;
export const DEFAULT_STREAM_WORDS_PER_CHUNK = 10;
...
export const MIN_TRANSCRIBE_TIMEOUT_MS = 1_000;
export const MAX_TRANSCRIBE_TIMEOUT_MS = 3_600_000;
export const MIN_STREAM_STEP_MS = 100;
export const MAX_STREAM_STEP_MS = 60_000;
export const MIN_STREAM_LENGTH_MS = 1_000;
export const MAX_STREAM_LENGTH_MS = 120_000;
export const MIN_STREAM_KEEP_MS = 0;
export const MAX_STREAM_KEEP_MS = 60_000;
export const MIN_STREAM_MAX_TOKENS = 1;
export const MAX_STREAM_MAX_TOKENS = 4_096;
export const MIN_STREAM_FLUSH_MS = 100;
export const MAX_STREAM_FLUSH_MS = 60_000;
export const MIN_STREAM_WORDS_PER_CHUNK = 1;
export const MAX_STREAM_WORDS_PER_CHUNK = 10;
export const MIN_STREAM_CAPTURE = -1;
export const MAX_STREAM_CAPTURE = 255;
export const MIN_STREAM_VAD_THRESHOLD = 0.01;
export const MAX_STREAM_VAD_THRESHOLD = 0.99;
