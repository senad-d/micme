...
export function buildConfigurationItems(modelCandidates: ModelCandidate[], audioDevices: AudioDeviceCandidate[], theme: MicmeTheme): ConfigurationItem[] {
	...
	return [
		...
		},
		{
			...
			description: "Raw recording sample rate. 48000 is usually best for macOS devices.",
		...
		},
		{
			...
			categoryId: "audio",
			label: "Keep audio",
			description: "Keep raw.wav and clip.wav in /tmp after successful transcription for debugging.",
